...
function Banner({ firmaInfo }: Props) {
  return (
    <div
      className="relative  flex flex-col lg:flex-row lg:space-x-5 h-[40rem] justify-between  font-bold
      ...
      {firmaInfo.map((firmaInfo) => (
        <div key={firmaInfo._id}>
          ...
          <div className="pt-56 absolute ">
            ...
            <h2
              className="mt-5 md:mt-8 text-2xl md:text-3xl font-semibold
                      text-white"
            >
              <span>
                {" "}
                <Typewriter
                  ...
                  delaySpeed={1000}
                  words={[
                    `${firmaInfo.shortTitle1} `,
                    `${firmaInfo.shortTitle2} `,
                  ]}
                />{" "}
              </span>
